...
def main(argv):
    ...
    # find the minute when one guard was most frequently asleep
    mx = 0
    ...
    print("The ID of the guard I chose multiplied by the minute I chose is {}"
          .format(gid * guards[gid].index(max(guards[gid]))))
                        # index of highest value in list = minute I choose
